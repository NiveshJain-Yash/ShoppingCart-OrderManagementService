...
describe('CartSidebar Component (FR-11, FR-12)', () => {
  ...
  it('should render empty cart message when no items', () => {
    render(
      <CartSidebar items={[]} subtotal={0} discount={0} total={0}
        onUpdateQuantity={mockOnUpdateQuantity} onRemoveItem={mockOnRemoveItem} isLoading={false} />
    );
  ...
  it('should render cart items with name and price', () => {
    ...
    render(
      <CartSidebar items={mockItems} subtotal={51000} discount={0} total={51000}
        onUpdateQuantity={mockOnUpdateQuantity} onRemoveItem={mockOnRemoveItem} isLoading={false} />
    );
  ...
  it('should display subtotal correctly', () => {
    const mockItems = [{ itemId: '1', name: 'Product 1', price: 100, quantity: 2 }];
    render(
      <CartSidebar items={mockItems} subtotal={200} discount={0} total={200}
        onUpdateQuantity={mockOnUpdateQuantity} onRemoveItem={mockOnRemoveItem} isLoading={false} />
    );
  ...
  it('should display discount when applied', () => {
    const mockItems = [{ itemId: '1', name: 'Product 1', price: 100, quantity: 2 }];
    render(
      <CartSidebar items={mockItems} subtotal={200} discount={50} total={150}
        onUpdateQuantity={mockOnUpdateQuantity} onRemoveItem={mockOnRemoveItem} isLoading={false} />
    );
  ...
  it('should disable buttons when isLoading is true', () => {
    ...
    render(
      <CartSidebar items={mockItems} subtotal={200} discount={0} total={200}
        onUpdateQuantity={mockOnUpdateQuantity} onRemoveItem={mockOnRemoveItem} isLoading={true} />
    );
